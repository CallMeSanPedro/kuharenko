...
- поддерживать смену шаблона стиля через меню-гамбургер в шапке (подмена целого ResourceDictionary темы: `Theme.Default.xaml`, `Theme.Modern.xaml`, `Theme.Legacy.xaml`, `Theme.Contrast.xaml` с динамической заменой цветов, формы табов и скруглений карточек)
